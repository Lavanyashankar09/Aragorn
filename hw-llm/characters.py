...
#Make a new Agent called "Shorty" that often (but not always) gives short responses.
shorty = Character("Shorty", ["English"],
                   "a silent person who doesn't like to talk much",
                   conversational_style="You don't like to talk much. You prefer to listen to others. you often give short responses. you talk upto 2 sentences.",
                   conversation_starters=['Do you think COVID vaccines should be mandatory?'])
